...
public class FloodingEvaluationUnit extends EvaluationUnit {
	...
	public void evaluateSpeedAnalysis() {
		...
		for (int i = 0; i < networkWidth.length; i++) {
			...
			System.out.println("Max Simulation for " + Math.pow(networkWidth[i], 2) + " nodes completed. Transmission time: " + transmissionTime_max[1][i] +" s");
			...
			transmissionTime_med[1][i] = floodingSimulator.speedAnalysis(networkWidth[i], 0, (networkWidth[i] / 2) * networkWidth[i] + networkWidth[i] / 2) /1000.0;
	...
	public void evaluateNetworkLivetimeStaticSendBehaviorOneDestination(int payloadSize) {
		...
		String filename = "Output/Flooding/Flooding_Lebenszeitanalyse_OneDestination_" + payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
			// TODO Auto-generated catch block
		...
		filename = "Output/AODV_RFC/AODV_Lebenszeitanalyse_oneDestination_prozentualeZeit_Sendemodus_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/AODV_RFC/AODV_Lebenszeitanalyse_oneDestination_prozentualeZeit_IdleModus_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/AODV_RFC/AODV_Lebenszeitanalyse_oneDestination_prozentualeZeit_WaitingForMediumAccesPermission_"
				+ payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/AODV_RFC/AODV_Lebenszeitanalyse_oneDestination_prozentualeZeit_ReciveModus_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
	...
	public void evaluateNetworkPartitioningAnalysisOneDestination(int payloadSize) {
		...
		String filename = "Output/Flooding/Flooding_partitionierungsanalyse_OneDestination_" + payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
			// TODO Auto-generated catch block
		...
		filename = "Output/Flooding/Flooding_partitionierungsanalyse_prozentualeZeit_Sendemodus_OneDestination_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/Flooding/Flooding_partitionierungsanalyse_prozentualeZeit_IdleModus_OneDestination_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/Flooding/Flooding_partitionierungsanalyse_prozentualeZeit_WaitingForMediumAccesPermission_OneDestination_"
				+ payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/Flooding/Flooding_partitionierungsanalyse_prozentualeZeit_ReciveModus_OneDestination_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
	...
	public void evaluateNetworkPartioningAnaylsisRandomSorceAndDest(int payloadSize, int maxPairs){
		...
		String filename = "Output/Flooding/Flooding_Partitionierungsanalyse_randomSourceAndDest_" + payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
			// TODO Auto-generated catch block
