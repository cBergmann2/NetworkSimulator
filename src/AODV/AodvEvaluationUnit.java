...
public class AodvEvaluationUnit extends EvaluationUnit {
	...
	public void evaluateNetworkLivetimeStaticSendBehavior(int payloadSize) {
		...
		String filename = "Output/AODV/AODV_Lebenszeit_statisch_" + payloadSize + "Byte.png"; 
		try {
		...
		filename = "Output/AODV/AODV_Lebenszeit_statisch_prozentualeZeit_Sendemodus_" + payloadSize + "Byte.png"; 
		try {
