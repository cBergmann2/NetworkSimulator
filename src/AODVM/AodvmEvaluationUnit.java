...
public class AodvmEvaluationUnit extends EvaluationUnit {
	...
	private static final int networkWidth[] = { 2, 3, 4, 5, 6, 7, 8, 9, 10};	//Network width
	...
	public void evaluateCostAnalysis() {
		...
		for (int i = 0; i < networkWidth.length; i++) {
			...
			maxDistance_onlyPayloadMsg[1][i] = aodvmSimulator.energyCostAnalysisWithoutRDP(networkWidth[i],
					0, (int) Math.pow(networkWidth[i], 2) - 1);
			energyDependendOnRouteDistance[0][i] = aodvmSimulator.getRouteDistance();
		...
		// Consumed Energy dependend on Route distance
				dataset2 = new DefaultXYDataset();
				dataset2.addSeries("Distanz", energyDependendOnRouteDistance);
				...
				try {
					ChartUtilities.saveChartAsPNG(new File("Output/AODVM/AODVM_Umgesetzte_Energie_in_Abhängigkeit_von_Distanz.png"),
							chart2, CHART_WIDTH, CHART_HIGHT);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
	...
	public void evaluateNetworkLivetimeRandomSorceAndDest(int payloadSize, int maxPairs){
		...
		String filename = "Output/AODVM/AODVM_Lebenszeitanalyse_randomSourceAndDest_" + payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	public void evaluateNetworkPartitioningAnalysis(int payloadSize) {
		...
		String filename = "Output/AODVM/AODVM_partitionierungsanalyse_" + payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
			// TODO Auto-generated catch block
		...
		filename = "Output/AODVM/AODVM_partitionierungsanalyse_prozentualeZeit_Sendemodus_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/AODVM/AODVM_partitionierungsanalyse_prozentualeZeit_IdleModus_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/AODVM/AODVM_partitionierungsanalyse_prozentualeZeit_WaitingForMediumAccesPermission_"
				+ payloadSize + "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
		...
		filename = "Output/AODVM/AODVM_partitionierungsanalyse_prozentualeZeit_ReciveModus_" + payloadSize
				+ "Byte.png";
		try {
			ChartUtilities.saveChartAsPNG(new File(filename), chart2, CHART_WIDTH, CHART_HIGHT);
		} catch (IOException e) {
